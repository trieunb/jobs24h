		...
		<div class="container">
			...
			<section id="content" class="pull-right right">
				<div class="box">
					...
					<div class="filter">
						<span>Hiển thi <span class="text-orange">1</span> - <span class="text-orange">10</span> của <span class="text-orange">11</span> thư.</span>
					...
					<table class="table table-blue-bordered table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>15/11/2010</td>
								<td>MP Telecom - Thank you for applying</td>
								<td>Cá nhân</td>
