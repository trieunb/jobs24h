...
Route::group(array('prefix'=>$locale), function() {
	Route::group(array('prefix'=>'dao-tao'), function() {
		...
		Route::get('/tai-lieu/{id}/{slug}', array('as'=>'trainings.detaildoc', 'uses'=>'TrainingController@detail_doc')); 
		...
		Route::get('/khoa-hoc/{id}/{slug}',array('as'=>'trainings.detailcouser', 'uses'=>'TrainingController@detail_couser'));
		Route::post('/khoa-hoc/{id}/{slug}',array('as'=>'trainings.detailcouser', 'uses'=>'TrainingController@post_detail_couser'));
