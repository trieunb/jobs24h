	...
	public function doRegister() 
	{
		...
		if($validator->fails())
		{
			...
			try {
				...
				<br>Đây là thông tin quan trọng về tài khoản mới của bạn. Bạn nên giữ lại email này để bảo lưu thông tin.
				
				<table border=\"1\">
				 
				<tr>
					<td style=\"padding:10px\">Tài khoản truy cập : </td><td style=\"padding:10px\">".$params['email']."</td>
				</tr>
				<tr>
					<td style=\"padding:10px\">Mật khẩu: </td><td style=\"padding:10px\">".$params['password']."</td>
				</tr>
				</table>
