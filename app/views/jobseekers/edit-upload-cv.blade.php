					...
					{{Form::open(array('route'=>array('jobseekers.post-update-upload-cv', $my_resume->id) ,'class'=>'form-horizontal', 'id'=>'UpdateNewCV','method'=>'POST', 'files'=>'true'))}}
			            ...
			            <div class="form-group">
			             ...
			             <div class="form-group">
			                ...
			                <div class="col-sm-3">
			                	{{Form::input('text','info_years_of_exp', $my_resume->namkinhnghiem, array('class'=>'info_years_of_exp form-control edit-control text-blue','id'=>'info_years_of_exp', 'maxlength'=>'2', 'placeholder' => 'Ví dụ 2'))}}
			                </div>
			                <div class="col-sm-6">
			                    <div class="checkbox">
			                    	<label>
