...
@section('title') Tạo mới thư trả lời tự động @stop
@section('content')
			...
			<section id="content" class="pull-right right">
				<div class="boxed">
					<div class="heading-image">
						<h2 class="text-blue">{{ HTML::image('assets/ntd/images/icon-respond-auto.png') }} Tạo trả lời tự động mới thư </h2>
					</div>
					...
					@include('includes.notifications')
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								{{ Form::textarea('content', '', ['required', 'id'=>'letter-content']) }}
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Loại:</label>
							<div class="col-sm-2">
								{{ Form::select('type', [1=>'Cá nhân', 2=>'Dùng chung']) }}
							</div>
						</div>
					
						<div class="form-group">
							<div class="col-sm-10 col-sm-offset-2">
								<button type="submit" class="btn btn-lg bg-orange">Tạo mới</button>
							</div>
						</div>
					</form>
