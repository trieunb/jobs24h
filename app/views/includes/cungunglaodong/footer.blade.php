		...
		<footer id="footer" class="bg-dark">
			...
			<div class="clearfix"></div>
			<p class="copy-right bg-black">Copyright 2015 Công ty TNHH Minh Phúc - MPTelecom</p>
		</footer>
		<!-- jQuery -->
		 
		{{ HTML::script('cungunglaodong/assets/js/jquery.1.11.1.min.js') }}
   		{{ HTML::script('cungunglaodong/assets/js/bootstrap.min.js') }}
    	{{ HTML::script('cungunglaodong/assets/js/main.js') }}
	</body>
</html>