	...
	<span class="bg-orange relative">
		<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
	   	...
	   	<ul class="dropdown-menu" role="menu">
	      	...
	      	<li><a href="ntv-chinhsuatk.php">{{ HTML::image('assets/images/icons/user.png') }} Chỉnh sửa thông tin tài khoản</a></li>
	      	<li><a href="ntv-hoso.php">{{ HTML::image('assets/images/icons/profile.png') }} Hồ sơ và thư tự giới thiệu</a></li>
	      	<li><a href="ntv-hosotumaytinh.php">{{ HTML::image('assets/images/icons/computer.png') }} Hồ sơ tải từ máy tính</a></li>
	      	<li><a href="#">{{ HTML::image('assets/images/icons/jobs.png') }} Việc làm phù hợp với bạn<span class="badge">2</span></a></li>
