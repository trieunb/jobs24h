...
@section('title')Thêm mới ngành nghề @stop
@section('page-header')Thêm mới ngành nghề @stop
@section('content')
	{{ Form::open( array('route'=>array('admin.category.add.post'), 'class'=>'form-horizontal', 'method'=>'POST') ) }}
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				{{ Form::select('parent', array('0'=>'None')+$categories, null)}}
			</div>
		</div> 
		<div class="form-group">
