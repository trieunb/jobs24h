...
@section('content')
	...
	<div class="row">
		...
		<table class="table table-bordered">
			<tbody>
				<tr>
					<td class="col-sm-9">Tổng số NTV không đăng kí</td>
					<td  style="text-align:right"><strong>{{count($jobseekers)}}</strong></td>
				</tr>
			</tbody>
		</table>
		</div>
...
@section('script')
	...
	<script type="text/javascript">
		$('#jobseekers').dataTable( {
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "{{ URL::route('jobseekers.not-login.datatables') }}",
				bAutoWidth: false,
					"aoColumns": [
