...
@section('title')Các việc làm đã ứng tuyển @stop
@section('page-header')Các việc làm đã ứng tuyển @stop
@section('content')
...
@section('script')
	...
	<script type="text/javascript">
		...
		oTable=$('#jobs').dataTable( {
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "{{ URL::route('admin.jobseekers.list-job-applied-datatables', [$id]) }}",
				bAutoWidth: false,
					"aoColumns": [
