									...
									<div class="col-sm-12 infobox-container">
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">{{ $ntvLogin }}/{{ $totalNTV }}</span>
										...
										<div class="infobox infobox-blue">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">{{ $ntdLogin }}/{{ $totalNTD }}</span>
									...
									<div class="col-sm-12 infobox-container">
										<div class="infobox infobox-green">
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">Tổng số bài viết</div>
											</div>
										...
										<div class="infobox infobox-blue">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">{{ $totalTraining }}</span>
										...
										<div class="infobox infobox-pink">
											...
											<div class="infobox-data">
												<span class="infobox-data-number">{{ $totalDoc }}</span>
